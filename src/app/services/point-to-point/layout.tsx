...
const PAGE_PATH = '/services/point-to-point/'
const SITE_URL = 'https://limotech.ca'
const PAGE_URL = `${SITE_URL}${PAGE_PATH}`

const PAGE_TITLE = 'Private Point-to-Point Car Service in Montreal'
const PAGE_DESCRIPTION =
  'Private point-to-point car service in Montreal. Direct door-to-door transfers with a professional chauffeur, flat-rate pricing and no hidden fees.'
  ...
  '@graph': [
    {
      ...
      hasOfferCatalog: {
        ...
        itemListElement: pp.useCases.items.map((item) => ({
          '@type': 'Offer',
          itemOffered: {
            '@type': 'Service',
            name: item.title,
    ...
    {
      '@type': 'FAQPage',
      mainEntity: pp.faq.items.map((item) => ({
        '@type': 'Question',
        name: item.question,
        acceptedAnswer: {
          '@type': 'Answer',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Point-to-Point Transfers', item: PAGE_URL },
      ],
    },
  ],
}
